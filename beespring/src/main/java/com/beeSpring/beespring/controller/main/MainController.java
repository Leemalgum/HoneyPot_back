...
public class MainController {
    ...
    @GetMapping(path = "/filterCategoryIdolName/{serialNumber}")
    public List<IdolDTO> showIdolListByCategory(@PathVariable("serialNumber") String serialNumber) {

        return mainService.showIdolCategoryName(serialNumber);


    }


    @GetMapping(path = "/filterByCategory/{idolName}")
    public ResponseEntity<List<MainProductDTO>> showProductsFilterByCategory(@PathVariable("idolName") String idolName) {
